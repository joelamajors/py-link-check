...
class HmblogSpider(scrapy.Spider):
    ...
    name = 'hmblog_twill'
    start_urls = ['https://aac.hatfield.marketing/blog?all-page=1']
    headers = {
        "Accept": "application/json, text/plain, */*",
        "Authorization":"null null",
        "Referer": "https://aac.hatfield.marketing/blog",
    ...
    def parse(self, response):
        url = "https://aac.hatfield.marketing/api/posts?blog%5B%5D=1&count=6&locale=en&order-by=publish_start_date"
    ...
    def parse_api(self, response):
        ...
        for blog in blog_data:
            blog_url = "https://aac.hatfield.marketing" + blog["full_slug"]
